...
export declare const AntigravityConfigSchema: z.ZodObject<{
    ...
    transport: z.ZodDefault<z.ZodObject<{
        ...
        cli: z.ZodOptional<z.ZodObject<{
            ...
            print_timeout_seconds: z.ZodDefault<z.ZodNumber>;
            process_timeout_seconds: z.ZodDefault<z.ZodNumber>;
            log_file: z.ZodOptional<z.ZodString>;
            sandbox: z.ZodDefault<z.ZodBoolean>;
            dangerously_skip_permissions: z.ZodDefault<z.ZodBoolean>;
        }, z.core.$strip>>;
        managed_agent: z.ZodOptional<z.ZodObject<{
            enabled: z.ZodDefault<z.ZodBoolean>;
